...
/// <summary>
/// Formats any given integer into a base-5 representation.
/// </summary>
public sealed partial class FiveAdicIntegerFormatter :
...
{
    /// <summary>
    /// Gets the default instance of the <see cref="FiveAdicIntegerFormatter"/>.
    /// </summary>
    static public FiveAdicIntegerFormatter Default { get; } = new();

    /// <summary>
    /// Formats the <paramref name="integer"/> into a base-5 representation.
    /// </summary>
    /// <param name="integer">The number to format.</param>
    /// <returns>The <paramref name="integer"/> in base-5 representation.</returns>
    ...
    {
        Span<Char> builder = stackalloc Char[7];
    ...
    {
        Span<Char> builder = stackalloc Char[14];
    ...
    {
        Span<Char> builder = stackalloc Char[28];
